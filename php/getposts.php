...
function getMainPost(){
    ...
    while($row= mysqli_fetch_array($result)){
        ...
        <div class="card mb-3 ml-3" style="max-width: 540px; text-align: justify;" id="bg">
            <img src="uploads/'.$row['photo'].'" class="card-img-top" id="image" alt="'.$row['title'].'" style="max-width: 200px; border: 2px solid #fff;">
            <div class="card-body">
              <h5 class="card-title" ><a href="./repeat.php" id="font">'.$row['title'].'</a></h5>
