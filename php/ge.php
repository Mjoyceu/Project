...
function Post(){
    ...
    while($row= mysqli_fetch_array($result)){
        ...
        echo'
        <div class="mx-4">
        <a href="re.php?news= '.$row['id'].'"><h5 class="card-title"  ><p id="font">'.$row['title'].'</p></h5></a>
        <img src="uploads/'.$row['photo'].'" class="card-img-top" alt="'.$row['title'].'" style="max-width: 200px; justify-content:center; border: 2px solid #fff;">
